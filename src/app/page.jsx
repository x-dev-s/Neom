...
import  AChart  from "@/components/UI/Dashboard/AreaChart";
import Kpi1 from "@/components/UI/Dashboard/kpi1";
import TrackerComponent from "@/components/UI/Dashboard/tracker";
import StockTracker from '@/components/UI/Dashboard/StockTracker';
      ...
      <div className="w-full h-full max-w-7xl overflow-hidden">
          ...
          <div className="w-full flex flex-wrap lg:flex-nowrap gap-3">
              ...
              <div className="w-dvw lg:w-[65%] flex flex-col gap-3">
                  ...
                  <div className="w-full h-full flex flex-wrap md:flex-nowrap gap-3">
                      <div className="w-full md:w-1/3 min-h-72  bg-white overflow-hidden rounded-2xl flex items-center justify-center">
                      <TrackerComponent 
              ...
              <div className="w-dvw lg:w-[35%] flex flex-wrap md:flex-nowrap flex-col md:flex-row lg:flex-col items-center gap-3">
                  ...
                  <div className="w-full md:w-1/2 lg:w-full min-h-296  bg-white overflow-hidden rounded-2xl flex items-center justify-center">
