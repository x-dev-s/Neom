          ...
          <ThemeProvider defaultTheme="system" attribute="class" className>
            {/* <div className="flex flex-col h-full justify-stretch w-full items-stretch lg:flex-row"> */}
              <SidebarProvider defaultOpen={defaultOpen}>
                ...
                <header className="sticky top-0 z-10 flex h-16 shrink-0 items-center gap-2 border-b border-gray-200 bg-white px-4 dark:border-gray-800 dark:bg-gray-950 overflow-hidden">
