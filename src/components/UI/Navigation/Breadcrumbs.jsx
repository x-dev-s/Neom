      ...
      <ol role="list" className="flex items-center space-x-3 text-sm">
        ...
        {breadcrumbs.map((crumb, index) => (
          <li key={crumb.href} className="flex items-center">
            ...
            <Link
              href={crumb.href}
              className={`ml-2 ${index === breadcrumbs.length - 1 ? "text-gray-900 dark:text-gray-50" : "text-gray-500 transition hover:text-gray-700 dark:text-gray-400 hover:dark:text-gray-300"}`}
